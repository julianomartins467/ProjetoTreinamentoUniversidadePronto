...
namespace Universidade.Controllers
{
    public class AlunosController : Controller
    {
        ...
        {
            bool valido = await _alunorepositorio.ValidarCPF(aluno.cpf);
            var y = await _alunorepositorio.Index();
            if (valido)
            {
        ...
        {
            AlunocomCurso aluno = await _alunorepositorio.Atualizar_get(id);  
            return View(aluno);
        }
